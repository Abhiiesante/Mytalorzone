                    ...
                    <div key={index} className='py-4 border-t border-b text-gray-700 flex felx-col md:flex-row md:items-center md:jusitfy-between gap-4'>
                        <div className='flex items-start gap-6'>
                            ...
                            <div>
                                ...
                                <p className='mt-2'>Date: <span className='text-gray-400'>03, Apr, 2005</span></p>
                            </div>
                        </div>
                        <div className='md:w-1/2 flex justify-between'>
                            ...
                            <button className='bg-black text-white text-sm py-2 px-4 font-medium rounded-sm'>TRACK ORDER</button>
                        </div>
                    </div>
                ))}
            </div>
