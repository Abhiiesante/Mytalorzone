    ...
    const onSumbitHandler = async (e) => {
        ...
        try {
            if (currentState === 'Sign Up') {
                const response = await axios.post("https://mytalorzone-backend.vercel.app/register", { name, email, password });
                ...
                const response = await axios.post("https://mytalorzone-backend.vercel.app/login", { email, password });
                if (response.data.success) {
                    setToken(response.data.token);
                    localStorage.setItem('token', response.data.token);
